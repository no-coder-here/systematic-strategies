# Experiment Registry — SPECIFICATION v1.1 (QR-INFRA-002)

**Status: FROZEN — 2026-08-17, Research Lead.**
Frozen after independent spec audit of v1.0 returned **SPEC FAIL** (16 blocking defects, 15
material warnings, 15 inert-test/vacuous-mutation findings). Every finding is adjudicated below;
v1.0 snapshot: `docs/spec_history/experiment_registry_spec_v1.0.md`.
